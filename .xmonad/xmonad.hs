...
import XMonad
import XMonad.Util.Run -- To RUN modules
import XMonad.Layout.Spacing  -- To add gaps between windows
import Data.Monoid
import System.Exit
import XMonad.Hooks.ManageDocks -- To manage docking programs
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm              , xK_F12   ), spawn "lux -a 10%")
   -- Decrease display brightness
    , ((modm              , xK_F11   ), spawn "lux -s 10%")
   -- Mute audio
